...
app_ui <- function(request) {
  tagList(
    ...
    bslib::page_navbar(nav_item(tags$img(src = "assets/logo.png", height = "40vh")),
      ...
      id = "mainNavbar",
      theme = bs_theme(
        version = 5, bootswatch = "lumen", primary = "#6e944eff", secondary = "#deeed4ff",
      ...
      sidebar = bslib::sidebar(
        ...
        selectInput("select_scenario", "Szenario Klimaprojektion",
          choices = c("Mittleres Szenario (RCP4.5)", "Worst-Case Szenario (RCP8.5)"),
      ...
      bslib::nav_panel(
        title = "📊 Steckbriefe",
        value = "ranking",
         markdown("Diese Baumarten sind die Top-10 für deinen Standort in der gewählten Klimaprojektion. Unser Ranking bezieht sich nur auf
