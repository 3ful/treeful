...
biovars <- tibble::tibble(
  biovars = c(
    "BIO01", "BIO02", "BIO03", "BIO04", "BIO05", "BIO06", "BIO07", "BIO08", "BIO09",
    "BIO10", "BIO11", "BIO12", "BIO13", "BIO14", "BIO15", "BIO16", "BIO17", "BIO18", "BIO19"
  ),
  descr_de = c(
    "Jahresdurchschnittstemperatur", "Tagestemperaturspanne", "Isothermalität",
...
biovars_c <- c(
  "BIO01" = 1, "BIO02" = 2, "BIO03" = 3, "BIO04" = 4, "BIO05" = 5, "BIO06" = 6, "BIO07" = 7, "BIO08" = 8, "BIO09" = 9,
  "BIO10" = 10, "BIO11" = 11, "BIO12" = 12, "BIO13" = 13, "BIO14" = 14, "BIO15" = 15, "BIO16" = 16, "BIO17" = 17,
  "BIO18" = 18, "BIO19" = 19
)

soil_vars_c <- c(
  "STU_EU_DEPTH_ROOTS" = 1, "STU_EU_T_CLAY" = 2, "STU_EU_S_CLAY" = 3, "STU_EU_T_SAND" = 4, "STU_EU_S_SAND" = 5, "STU_EU_T_SILT" = 6,
...
soil_vars <- tibble::tibble(
  soilvars = c(
    "STU_EU_DEPTH_ROOTS", "STU_EU_T_CLAY", "STU_EU_S_CLAY", "STU_EU_T_SAND", "STU_EU_S_SAND", "STU_EU_T_SILT", "STU_EU_S_SILT",
  ...
  descr_de = c(
    "Wurzelverfügbare Tiefe cm", "Tonanteil % Oberboden", "Tonanteil % Unterboden",
...
experiment <- tibble(
  label = c("Mittleres Szenario (RCP4.5)", "Worst-Case Szenario (RCP8.5)"),
  id = c("rcp45", "rcp85")
)
